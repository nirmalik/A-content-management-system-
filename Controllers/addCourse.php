...
if (($_POST['description'] != "") && ($_POST['Cname'] != "") && ($_POST['Cphone'] != "")) {
    ...
    if (strlen($number) < 10 || strlen($number) > 10) {
        ...
        echo "fileErr";
           ...
           // if image uploaded check extensions and save to uploadedFile - save post values to class Course and create if form is validated - echo ok if it is.
